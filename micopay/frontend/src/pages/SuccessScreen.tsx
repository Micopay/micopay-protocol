    ...
    return (
        <main className="min-h-screen flex flex-col items-center justify-between px-6 py-12 max-w-md mx-auto bg-surface-container-lowest font-body text-on-surface antialiased">
            ...
            <div className="w-full pt-8">
                <button
                    onClick={onHome}
                    className="w-full h-[54px] from-primary to-primary-container text-papel font-bold rounded-sm active:scale-95 transition-all flex items-center justify-center gap-2"
                >
